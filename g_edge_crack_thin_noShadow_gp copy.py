...
def draw_crack(
    ...
    reflect_color= (255,255,255),        # NEW: e.g. (180, 220, 255) for icy blue, (255, 200, 120) for gold. None = old lighten behavior
):
    ...
    # Both the dark core AND the rim are measured against this LOCAL scale
    # (not the crack's global widest point), so:
    #   - the core width and the rim width both scale with the crack's
    #     actual local thickness (thin where the crack is thin), and
    #   - a rim threshold chosen to sit just inside the core's own threshold
    #     is *guaranteed* to touch it everywhere, not just at the widest
    #     point of the whole stroke - no more gap, no more "thick no matter
    #     what" band.
