...
class RoundedButton(tk.Canvas):
    ...
    def __init__(self, parent, image, command, bg_parent, base_bg, hover_bg,
                 ...
                 text=None, text_angle=0, font=("Times New Roman", 16, "normal"), fg=TEXT_LIGHT,
...
class ImagePainterApp:
    ...
    def _build_title_bar(self, parent):
        ...
        self.folder_nav_label = tk.Label(
            ...
            font=("Times New Roman", 10, "normal"), width=12, anchor="center",
        )
    ...
    def _build_canvas(self, parent):
        ...
        self.placeholder_id = self.canvas.create_text(
            ...
            fill=TEXT_DIM, font=("Times New Roman", 14),
        )
        ...
        self.status_label = tk.Label(
            ...
            bg=BG_DARK, fg=TEXT_DIM, font=("Times New Roman", 9),
        )
        ...
        self.zoom_label = tk.Label(self.zoom_overlay, text="100%", bg=BG_PANEL, fg=TEXT_LIGHT,
                                    font=("Times New Roman", 9, "normal"), width=4)
    ...
    def _build_toolbar(self, parent):
        ...
        def section_title(text):
            tk.Label(top, text=text, bg=BG_PANEL, fg=TEXT_DIM,
                     font=("Times New Roman", 9, "normal")).pack(anchor="w", padx=16, pady=(18, 4))
        ...
        tk.Label(top, text="CrackGeneratorGUI", bg=BG_PANEL, fg=TEXT_LIGHT,
                 font=("Times New Roman", 13, "normal")).pack(anchor="w", padx=16, pady=(18, 0))
        ...
        self.upload_mode_menu.config(
            ...
            font=("Times New Roman", 10), highlightthickness=0, cursor="hand2",
        ...
        self.size_value_label = tk.Label(
            size_row, text=f"{self.brush_size:.2f}", bg=BG_PANEL, fg=TEXT_DIM, font=("Times New Roman", 9)
        )
        ...
        self.colorscale_value_label = tk.Label(
            colorscale_row, text="0", bg=BG_PANEL, fg=TEXT_DIM, font=("Times New Roman", 9)
        )
        ...
        self.edgescale_value_label = tk.Label(
            edgescale_row, text="255", bg=BG_PANEL, fg=TEXT_DIM, font=("Times New Roman", 9)
        )
        ...
        self.edge_btn = RoundedButton(
            ...
            bg_parent=BG_PANEL, base_bg=BTN_BG, hover_bg=BTN_BG_HOVER, active_bg=ACCENT,
            text="Edge", font=("Times New Roman", 9, "normal"),
        )
        ...
        self.crack_btn = RoundedButton(
            ...
            bg_parent=BG_PANEL, base_bg=BTN_BG, hover_bg=BTN_BG_HOVER, active_bg=ACCENT,
            text="Crack", font=("Times New Roman", 10, "normal"),
        )
        ...
        tk.Label(
            ...
            bg=BG_PANEL, fg=TEXT_DIM, font=("Times New Roman", 8), justify="left",
    ...
    def _make_button(self, parent, text, command, width=None, image=None, danger=False,
        ...
        kwargs = dict(
            ...
            relief="flat", bd=0, font=("Times New Roman", 10), cursor="hand2",
    ...
    def _caption_row(self, parent, labels):
        ...
        created = []
        for label in labels:
            lbl = tk.Label(row, text=label, bg=BG_PANEL, fg=TEXT_DIM, font=("Times New Roman", 8))
    ...
    def _start_eyedropper(self):
        ...
        readout = tk.Label(
            overlay, text="", font=("Times New Roman", 11, "normal"),
            bd=1, relief="solid", padx=8, pady=4,
        )

        hint = tk.Label(
            overlay, text="Click to pick a color  \u2022  Esc to cancel",
            bg="#000000", fg="#ffffff", font=("Times New Roman", 10), padx=10, pady=6,
        )
